...
public class Fw_mqtt_class {
	...
	public Fw_mqtt_class() throws MqttException {
		...
		if(port == 1883){
			...
			throw new IllegalArgumentException("Please enter a vaild port.");
		}
	...
	// This Function is to subscribe to topic
	...
	// This Function is to publish data to topic
